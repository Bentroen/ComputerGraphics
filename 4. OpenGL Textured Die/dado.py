...
def cubo(): 
    ...
    f1 = (0, 1/2, 1/3, 1/2, 1/3, 1, 0, 1/2, 1/3, 1, 0, 1)
    f2 = (1/3, 1/2, 2/3, 1/2, 2/3, 1, 1/3, 1/2, 2/3, 1, 1/3, 1)
    f3 = (2/3, 1/2, 1, 1/2, 1, 1, 2/3, 1/2, 1, 1, 2/3, 1)
    f4 = (0, 0, 1/3, 0, 1/3, 1/2, 0, 0, 1/3, 1/2, 0, 1/2)
    f5 = (1/3, 0, 2/3, 0, 2/3, 1/2, 1/3, 0, 2/3, 1/2, 1/3, 1/2)
    f6 = (2/3, 0, 1, 0, 1, 1/2, 2/3, 0, 1, 1/2, 2/3, 1/2)
    ...
    #    1/3,   0, 1/3, 1/2, 2/3,   0,
    #    2/3, 1/2, 2/3,   1,   1, 1/2,
    #    1/3, 1/2, 1/3,   1, 2/3, 1/2,
    #    2/3,   0, 2/3, 1/2,   1,   0
    #])
    textura = array('f', [*f1, *f2, *f3, *f4, *f5, *f6])
    ...
    GL.glBufferData(GL.GL_ARRAY_BUFFER, len(textura)*textura.itemsize, ctypes.c_void_p(textura.buffer_info()[0]), GL.GL_STATIC_DRAW)
