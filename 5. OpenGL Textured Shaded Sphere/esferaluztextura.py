...
layout (location=2) in vec2 attr_textura;
...
void main(void) 
{
    ...
    vec4 objectColor = texture(textureSlot,fsTextura);
...
def malha(): 
    ...
    GL.glEnableVertexAttribArray(2) # Atributo da textura
    ...
    GL.glVertexAttribPointer(2,2,GL.GL_FLOAT,GL.GL_FALSE,0,ctypes.c_void_p(0))
